...
$('.panelprint').click(function showModal(){

    // Grab all info from HTML load for each employee
    printpk = $(this).find(".m-printpk").text();
    type = $(this).find(".m-printtype").text();
    location = $(this).find(".m-locname").text();
    statpic = $(this).find(".m-statpic").text();
